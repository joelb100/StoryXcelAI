...
const IconSidebar = ({ supportMenuOpen, setSupportMenuOpen, accountMenuOpen, setAccountMenuOpen, onSignOut }: { supportMenuOpen: boolean; setSupportMenuOpen: (open: boolean) => void; accountMenuOpen: boolean; setAccountMenuOpen: (open: boolean) => void; onSignOut: () => void; }) => (
      ...
      <div className="p-4 h-full overflow-y-auto" style={{ backgroundColor: '#47566b' }}>
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <Select value={overview.subGenres[0]} onValueChange={(v) => setField('subGenres', [v])}>
              <SelectTrigger className="bg-slate-600 border-slate-500 text-white">
...
const RightIconSidebar = ({ onFriendsListToggle, onSiteLinksToggle, activeTab }: { onFriendsListToggle?: () => void; onSiteLinksToggle?: () => void; activeTab: string }) => (
