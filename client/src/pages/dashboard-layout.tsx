          ...
          <div className={`transition-all duration-300 ${
            ...
            {activeTab === 'dashboard' ? (
              ...
              <div className="bg-gray-100 flex flex-col h-full">
                ...
                <div className="flex-1 flex justify-center overflow-hidden">
                  <div className="w-full max-w-[15.25in] p-4 flex flex-col h-full">
                    {/* Story Editor Section - 71.1% height (increased from 70.5%) */}
                    <div className="flex justify-center items-center" style={{ height: '71.1%' }}>
                    ...
                    {/* Bottom section - 28.9% height (reduced 2% from 29.5%) */}
                    <div className="flex flex-col justify-start pt-4" style={{ height: '28.9%' }}>
                      {/* AI Chat Window - takes remaining space */}
                      <AIStoryAssistant 
                        chatMessages={chatMessages}
                        chatMessage={chatMessage}
              ...
              <div className="bg-gray-100 flex flex-col h-full">
                ...
                <div className="flex-1 flex justify-center overflow-hidden">
                  <div className="w-full max-w-[15.25in] p-4 flex flex-col h-full">
                    {/* Main Builder Section - 71.1% height (increased from 70.5%) */}
                    <div className="flex justify-center items-center" style={{ height: '71.1%' }}>
