          ...
          <div className="col-span-19">
            {activeTab === 'story' ? (
              <div className="bg-gray-100 flex flex-col h-full">
                ...
                <div className="flex-1 flex justify-center overflow-hidden">
                  <div className="w-full max-w-[15.25in] p-4 flex flex-col h-full">
                    {/* Main Story Builder Section - Adjusted to give AI Assistant more space */}
                    <div className="flex justify-center items-center" style={{ height: 'calc(60% + 1in)' }}>
                    ...
                    {/* Bottom section - Increased by 0.75 inches for AI Assistant */}
                    <div style={{ height: 'calc(40% - 1in)' }} className="flex flex-col justify-start pt-4">
                      {/* AI Chat Window - increased height by 0.75 inches */}
                      <AIStoryAssistant 
                        chatMessages={chatMessages}
                        chatMessage={chatMessage}
                        setChatMessage={setChatMessage}
